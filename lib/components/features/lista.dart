...
const _featureTransferencia = 'transferencias';
const _tituloFeatureTransferencia = 'Transferência';

const _featureContatos = 'contatos';
const _tituloFeatureContatos = "Contatos";
...
class _ListaFeaturesState extends State<ListaFeatures> {
  ...
  ItemFeature _devolveItemFeature(Feature feature) {
    switch (feature.nome) {
      case _featureTransferencia:
        return ItemFeature(
          quandoClica: () => widget.quandoClicaTransacoes(),
          icone: Icons.monetization_on,
          texto: _tituloFeatureTransferencia,
        );
      case _featureContatos:
        return ItemFeature(
          quandoClica: () => widget.quandoClicaContatos(),
          icone: Icons.people,
          texto: _tituloFeatureContatos,
        );
